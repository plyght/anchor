...
const LOCATIONS = [
  { value: 'clifton', label: 'Clifton', lat: 24.8138, lon: 67.0299 },
  { value: 'defence-dha', label: 'Defence (DHA)', lat: 24.8084, lon: 67.0743 },
  { value: 'gulshan-e-iqbal', label: 'Gulshan-e-Iqbal', lat: 24.9211, lon: 67.0829 },
  { value: 'north-nazimabad', label: 'North Nazimabad', lat: 24.9249, lon: 67.0365 },
  { value: 'saddar', label: 'Saddar', lat: 24.8546, lon: 67.0271 },
  { value: 'malir', label: 'Malir', lat: 24.8912, lon: 67.2095 },
  { value: 'korangi', label: 'Korangi', lat: 24.8334, lon: 67.1177 },
  { value: 'lyari', label: 'Lyari', lat: 24.8725, lon: 66.9959 },
  { value: 'gulistan-e-jauhar', label: 'Gulistan-e-Jauhar', lat: 24.9148, lon: 67.1303 },
  { value: 'bahria-town', label: 'Bahria Town', lat: 24.9165, lon: 67.1893 },
  { value: 'kemari', label: 'Kemari', lat: 24.8002, lon: 66.9801 },
  { value: 'landhi', label: 'Landhi', lat: 24.8454, lon: 67.2061 },
  { value: 'orangi-town', label: 'Orangi Town', lat: 24.9502, lon: 66.9935 },
  { value: 'shah-faisal-colony', label: 'Shah Faisal Colony', lat: 24.8891, lon: 67.1482 },
  { value: 'tariq-road', label: 'Tariq Road', lat: 24.8740, lon: 67.0604 },
  { value: 'university-road', label: 'University Road', lat: 24.9434, lon: 67.1152 },
  { value: 'federal-b-area', label: 'Federal B Area', lat: 24.8950, lon: 67.0664 },
  { value: 'pechs', label: 'PECHS', lat: 24.8697, lon: 67.0654 },
  { value: 'north-karachi', label: 'North Karachi', lat: 24.9824, lon: 67.0434 },
  { value: 'surjani-town', label: 'Surjani Town', lat: 25.0265, lon: 66.9983 },
];
