...
export const list = query({
    args: {
        status: v.optional(v.union(v.literal("pending"), v.literal("dispatched"), v.literal("accepted"), v.literal("in_progress"), v.literal("completed"), v.literal("cancelled"), v.literal("failed"))),
...
export const update = mutation({
    args: {
        ...
        description: v.optional(v.string()),
        task_type: v.optional(v.union(v.literal("assessment"), v.literal("rescue"), v.literal("medical"), v.literal("evacuation"), v.literal("supplies"), v.literal("communication"), v.literal("coordination"))),
