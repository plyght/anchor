...
export const create = mutation({
    args: {
        ...
        current_status: v.optional(v.union(v.literal("online"), v.literal("offline"), v.literal("busy"), v.literal("responding"))),
        location: v.optional(v.object({
            lat: v.number(),
            lon: v.number(),
            address: v.string(),
...
export const getByStatus = query({
    args: {
        status: v.union(v.literal("online"), v.literal("offline"), v.literal("busy"), v.literal("responding")),
    },
    returns: v.array(v.object({
        _id: v.id("volunteers"),
        _creationTime: v.number(),
