...
export default defineSchema({
    ...
    volunteers: defineTable({
        ...
        current_status: v.union(v.literal("online"), v.literal("offline"), v.literal("busy"), v.literal("responding")),
    ...
    incidents: defineTable({
        ...
        incident_type: v.union(v.literal("flood"), v.literal("fire"), v.literal("earthquake"), v.literal("medical"), v.literal("rescue"), v.literal("infrastructure"), v.literal("other")),
        severity: v.union(v.literal("low"), v.literal("medium"), v.literal("high"), v.literal("critical")),
        trigger_data: v.optional(v.any()),
        status: v.union(v.literal("active"), v.literal("monitoring"), v.literal("resolved"), v.literal("cancelled")),
        location: v.optional(v.object({
            lat: v.number(),
            lon: v.number(),
            address: v.string(),
    ...
    tasks: defineTable({
        ...
        title: v.string(),
        description: v.optional(v.string()),
        task_type: v.union(v.literal("assessment"), v.literal("rescue"), v.literal("medical"), v.literal("evacuation"), v.literal("supplies"), v.literal("communication"), v.literal("coordination")),
        ...
        status: v.union(v.literal("pending"), v.literal("dispatched"), v.literal("accepted"), v.literal("in_progress"), v.literal("completed"), v.literal("cancelled"), v.literal("failed")),
    ...
    task_assignments: defineTable({
        ...
        acceptance_code: v.string(),
        status: v.union(v.literal("pending"), v.literal("accepted"), v.literal("declined"), v.literal("timeout"), v.literal("reassigned")),
